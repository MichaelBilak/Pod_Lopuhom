...
export const translations = {
  en: {
    ...
    order: {
      ...
      orderCta: "If you need additional information, write to me here:",
      whatsapp: "WhatsApp",
      instagram: "Instagram",
    },
    about: {
  ...
  ru: {
    ...
    order: {
      ...
      orderCta: "Если вам нужна дополнительная информация, пишите мне сюда:",
      whatsapp: "WhatsApp",
      instagram: "Instagram",
    },
    about: {
  ...
  it: {
    ...
    order: {
      ...
      orderCta: "Se hai bisogno di ulteriori informazioni, scrivimi qui:",
      whatsapp: "WhatsApp",
      instagram: "Instagram",
    },
    about: {
